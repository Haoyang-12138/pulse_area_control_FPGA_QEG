...
module dac2_sequence_generator_v3 #(
    ...
    input  logic [4:0]           segment_count_shadow_i,
        ...
        if (!rstn_i) begin
            ...
            if (!enable_i && apply_i) begin
                ...
                if (segment_cycle_count + 1'b1 >= current_duration) begin
                    ...
                    if (segment_index + 1'b1 >= active_segment_count) begin
                        ...
                        current_duration <=
                            segment_duration_cycles_shadow_i[segment_index + 1'b1];
                        current_level <=
                            segment_level_q16_shadow_i[segment_index + 1'b1];
                    end
                end
                else begin
